...
from attentd_and_excite.utils.ptp_utils import AttentionStore
from attentd_and_excite.config import RunConfig

def find_noun(prompts):
                ...
                for n in trange(opt.n_iter, desc="Sampling"):
                    for bid, prompts in enumerate(tqdm(data, desc="data")):
                        ...
                        image = pipe(prompt=prompts,
                                     ...
                                     # scale_range=(1.0, 0.5),
                                     # smooth_attentions=RunConfig.smooth_attentions,
                                     # sigma=RunConfig.sigma,
                                     # kernel_size=RunConfig.kernel_size,
                                     # sd_2_1=RunConfig.sd_2_1)
